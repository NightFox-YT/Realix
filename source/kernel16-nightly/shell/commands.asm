...
; (06.08.26) v0.11
; ================
; ❗️ Зависимости: bios-api/memory, kernel16-nightly/io, kernel16-nightly/shell/parse
;                 kernel16-nightly/debug/panic.asm
; TODO:
...
%include "kernel16-nightly/commands/base/cls.asm"

; > Команды для работы с текстом
%include "kernel16-nightly/commands/text.asm"

; > Команды для работы с числами
%include "kernel16-nightly/commands/nums.asm"

; > Команда простого калькулятора
%include "kernel16-nightly/commands/calc.asm"

; > Команда загрузки файла с диска
%include "kernel16-nightly/commands/file-system/load.asm"

; > Команда загрузки RLX приложения с диска
%include "kernel16-nightly/commands/file-system/exec.asm"

; > Команда вывода списка файлов
%include "kernel16-nightly/commands/file-system/ls.asm"

; > Команда печати файла как текста
%include "kernel16-nightly/commands/file-system/type.asm"

; > Команда шестнадцатеричного дампа файла
%include "kernel16-nightly/commands/file-system/hexdump.asm"

; > Команда вывода снимка регистров
%include "kernel16-nightly/commands/debug/regs.asm"

; > Команды вывода времени и даты (RTC)
%include "kernel16-nightly/commands/rtc.asm"

; > Команда демонстрации графического режима
%include "kernel16-nightly/commands/vga.asm"

; > Команды для вывода ascii/scancode клавиши
%include "kernel16-nightly/commands/debug/key.asm"

; > Команды для вывода системной информации
%include "kernel16-nightly/commands/debug/sysinfo.asm"

; > Команды для вывода аптайма
%include "kernel16-nightly/commands/debug/uptime.asm"

; > Команда помощи
%include "kernel16-nightly/commands/base/help.asm"

; > DOS: PSP-строитель и обработчик int 21h (Подмножество)
%include "kernel16-nightly/dos/psp.asm"
%include "kernel16-nightly/dos/int21.asm"

; > Команда запуска .COM-приложений MS-DOS
%include "kernel16-nightly/commands/file-system/msexec.asm"
