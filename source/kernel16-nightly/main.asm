...
; Подключение модулей
%include 'kernel16-nightly/io/print.asm'
%include 'kernel16-nightly/io/print_ctrl.asm'
%include 'kernel16-nightly/io/print_reg.asm'
%include 'kernel16-nightly/shell/cli.asm'
%include 'kernel16-nightly/shell/commands.asm'
...
%include 'kernel16-nightly/debug/panic.asm'
%include 'kernel16-nightly/syscall.asm'

; Сообщения и строки
msg_start_kernel: db '[+] Starting kernel16-nightly.', ENTER, 0
msg_enter_os:     db 'Press any key to continue.', 0
cli_title:        db 'Welcome to Realix Nightly (Real Mode with NASM kernel, MS-DOS support)...', ENTER, 0
