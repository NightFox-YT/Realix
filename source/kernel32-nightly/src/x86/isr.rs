...
use crate::drivers::{floppy, keyboard, pit};
use crate::halt_loop;
...
# > int 0x80: системные вызовы 32-битных RLX-приложений (Без аппаратного error code)
.global exc_syscall_80
exc_syscall_80:
    push 0
    push 0x80
    jmp syscall_common_stub

# > Точки входа: исключения CPU, аппаратные IRQ и syscall (int 0x80)
COMMON_STUB exc_common_stub, exc_handler
COMMON_STUB irq_common_stub, irq_handler
COMMON_STUB syscall_common_stub, syscall_handler
"#,
