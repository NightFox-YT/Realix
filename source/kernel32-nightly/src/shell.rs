...
fn execute(input: &str) {
    ...
    match name {
        ...
        "beep" => { commands::beep::run(); }
        "sysinfo" => { commands::sysinfo::show(); }
        "calc" => { commands::calc::run(args); }
        "hex" => { commands::numbers::hex(args); }
        "fib" => { commands::numbers::fib(args); }
        "len" => { commands::text::len(args); }
        "upper" => { commands::text::upper(args); }
        "lower" => { commands::text::lower(args); }
        "reverse" => { commands::text::reverse(args); }
        "repeat" => { commands::text::repeat(args); }
        "ascii" => { commands::text::ascii(args); }
        "regs" => { commands::regs::run(); }
        "time" => { commands::clock::time(); }
        "date" => { commands::clock::date(); }
        "vga" => { commands::vga_demo::run(); }
        "panic" => { commands::panic::run(); }
        "ls" => { commands::ls::run(); }
        "load" => { commands::load::run(args); }
        "type" => { commands::type_cmd::run(args); }
        "hexdump" => { commands::hexdump::run(args); }
