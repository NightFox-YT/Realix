...
; Адреса буферов для FAT12
FAT_BUFFER_ADDR    equ 0x0500  ; Буфер для FAT таблицы
ROOT_DIR_BUFFER    equ 0x0600  ; Буфер для корневого каталога (ls)
FAT_SAFE_ZONE_END  equ 0x7C00 ; Конец безопасной зоны (начало загрузчика)
